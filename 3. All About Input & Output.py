...
#We can also use 'tuple' nstead instead of 'list' to make a tuple with the inputs.
#Taking multiple input in a line (Case 4):
a, b, c = list(input("#CASE 4: Enter 3 Words(Using Space): ").split(","))#Enter 3 elements using coma(,) in between.... Then press enter
