...
print("CASE 2:",x2)
#Taking multiple input in a line (Case 3):
a, b, c = list(input("#CASE 3: Enter 3 Words(Using Space): ").split(" "))#Enter 3 numbers using space in between.... Then press enter
print("CASE 3:{} {} {}".format(a,b,c))
#Taking multiplle input defining it! (Case 4):
x, y, z = list(map(int,input("#CASE 4: Enter 3 numbers(Using Space): ").split(" ")))
print("#CASE 4:",x,y,z)
